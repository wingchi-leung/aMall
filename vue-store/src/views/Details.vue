    ...
    <div class="main">
      ...
      <div class="block">
        <el-carousel height="560px" v-if="productPicture.length>1">
          <el-carousel-item v-for="item in productPicture" :key="item.name">
            <img style="height:560px;" :src="item.url" :alt="item.description" />
          </el-carousel-item>
        </el-carousel>
        ...
        <div v-if="productPicture.length==1">
          <img
            style="height:560px;"
            :src="productPicture[0].images"
            :alt="productPicture[0].name"
          />
        </div>
      </div>
      <!-- 左侧商品轮播图END -->
      ...
      <div class="content">
        ...
        <div class="price">
          ...
          <span
            v-show="productDetails.sellingPrice != productDetails.price"
            class="del"
